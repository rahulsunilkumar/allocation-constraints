...
The data consist of adjusted daily closing prices downloaded from Yahoo Finance through \texttt{yfinance}, with automatic price adjustment enabled \cite{yfinance}. The saved prices cover January 3, 2007 through December 30, 2024. The download's December 31 end date is exclusive. Simple returns are
\begin{equation}
...
\bibitem{yfinance}
\emph{yfinance documentation}, ``yfinance.download.'' [Online]. Available: \url{https://ranaroussi.github.io/yfinance/reference/api/yfinance.download.html}.
